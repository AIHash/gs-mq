...
//
//import com.hhly.videogame.common.GameException;
//import com.hhly.videogame.common.constants.CacheEnum;
//import com.hhly.videogame.common.constants.MsgKeyEnum;
//import com.hhly.videogame.common.util.I18nMsgUtil;
//import com.hhly.videogame.common.util.ObjectUtil;
//import com.hhly.videogame.common.util.RedisUtil;
//
...
//
///**
// * RedisCacheManager是redis操作工具类
// *
// * @Description redis客户端封装类
// * @author lidujun
// * @date 2016-5-19
// * @updateby
// * @updatedate
...
//	 * redis key分隔符
//	 */
//	private final String REDIS_KEY_SEPERATOR = ":";
//
//	/**
//	 * 缓存生存时间
//	 */
...
//		return null;
////		return RedisUtil.getJedisCluster();
//	}
//
//	/**
//	 * 设置过期时间
...
//	}
//
//	private void returnJedis(Jedis jc){
//		RedisUtil.returnResource(jc);
//	}
//
//	private void returnJedis(JedisCluster jc){
////		RedisUtil.returnJedisClusterResource(jc);
//	}
//
//	/**
//	 * 设置默认过期时间/
...
//
//	/**
//	 * 构建redis String类型的key
//	 *
//	 * @param parts
//	 *            构建key的CacheEnum不定长参数
//	 */
//	public String buildKey(CacheEnum... parts) {
//		StringBuilder sb = new StringBuilder();
//		for (CacheEnum part : parts) {
//			sb.append(part.name()).append(REDIS_KEY_SEPERATOR);
//		}
...
//	 *            构建key的CacheEnum不定长参数
//	 */
//	public byte[] buildByteKey(CacheEnum... parts) {
//		try {
//			return buildKey(parts).getBytes("UTF-8");
//		} catch (UnsupportedEncodingException e) {
//			String errMsg = I18nMsgUtil.getI18nMsg(MsgKeyEnum.BUILD_CACHE_KEY_ERR);
...
//	 *            构建key的String不定长参数
//	 */
//	public byte[] buildByteKey(String... parts) {
//		try {
//			return buildKey(parts).getBytes("UTF-8");
//		} catch (UnsupportedEncodingException e) {
//			String errMsg = I18nMsgUtil.getI18nMsg(MsgKeyEnum.BUILD_CACHE_KEY_ERR);
...
//	 * @return 状态码
//	 */
//	public <T> String setObj(String key , T obj){
//		//JedisCluster jedis = RedisUtil.getJedisCluster();
//		Jedis jedis = RedisUtil.getJedis();
//		String status = jedis.set(buildByteKey(key),ObjectUtil.serialize(obj));
//		returnJedis(jedis);
//		return status;
//	}
//
//	public <T> String setClusterObj(String key , T obj){
//		JedisCluster jc = getJedisCluster();
//		String status = jc.set(buildByteKey(key),ObjectUtil.serialize(obj));
//		returnJedis(jc);
//		return status;
//	}
//
...
//		byte[] byteKeyArr = buildByteKey(key);
//		//JedisCluster jedis = RedisUtil.getJedisCluster();
//		Jedis jedis = RedisUtil.getJedis();
//		if(!jedis.exists(byteKeyArr)){
//			returnJedis(jedis);
//			return null;
//		}
//		byte[] in = jedis.get(byteKeyArr);
////		System.out.println("room obj len:"+in.length);
//		T obj = null;
//        try{
////            @SuppressWarnings("unchecked")
//        	obj =(T) ObjectUtil.deserialize(in);
//        }
//        catch(Exception e){
...
//			//JedisCluster sjedis = RedisUtil.getJedisCluster();
////			Jedis jedis = RedisUtil.getJedis();
//			Jedis sjedis = RedisUtil.getJedis();
...
//			//JedisCluster jedis = RedisUtil.getJedisCluster();
//			Jedis jedis = RedisUtil.getJedis();
//			String status = jedis.set(SafeEncoder.encode(key), SafeEncoder.encode(value),SafeEncoder.encode(nxxx),
...
//			//JedisCluster jedis = RedisUtil.getJedisCluster();
//			Jedis jedis = RedisUtil.getJedis();
//			String status = jedis.set(buildByteKey(key),ObjectUtil.serialize(list));
//			returnJedis(jedis);
//			return status;
//		}
//
...
//		 * @return 状态码
//		 */
//		public <T> String setSet(String key ,Set<T> set){
//			//JedisCluster jedis = RedisUtil.getJedisCluster();
//			Jedis jedis = RedisUtil.getJedis();
//			String status = jedis.set(buildByteKey(key),ObjectUtil.serialize(set));
//			returnJedis(jedis);
//			return status;
//		}
//
...
//			returnJedis(jedis);
//	        @SuppressWarnings("unchecked")
//			Set<T> set = (Set<T>) ObjectUtil.deserialize(in);
//			return set;
//		}
//
//		/**
...
//		 * @return 状态码
//		 */
//		public <T> String setMap(String key ,Map<String,T> map){
//			//JedisCluster jedis = RedisUtil.getJedisCluster();
//			Jedis jedis = RedisUtil.getJedis();
//			String status = jedis.set(buildByteKey(key),ObjectUtil.serialize(map));
//			returnJedis(jedis);
//			return status;
//		}
//
